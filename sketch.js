...
function traitement_couleurs(mot_ordinateur,mot_joueur) { //fonction permettant de traiter les couleurs selon les lettres saisies par le joueur.
...
function affichage(mot_ordinateur,compteur_essais){
  ...
  // quand un essai est fait, passer à la ligne suivante de la grille et stocker les caractères
   text(mot_ordinateur[colonne],68 + 50*colonne, 180+compteur_essais*50) 
